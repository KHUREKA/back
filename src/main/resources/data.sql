...
('뮤지컬 오페라의 유령', 'MUSICAL', '오페라의유령 뮤지컬 브로드웨이', '블루스퀘어 신한카드홀', '서울특별시 용산구 이태원로 294', 37.5415021, 126.9936951,
 ...
 'https://ap-northeast-2.console.aws.amazon.com/s3/object/khuthon-bucket?region=ap-northeast-2&prefix=events/7e7cb371-048f-430a-9d42-72e58d6ed211_%EC%98%A4%ED%8E%98%EB%9D%BC%EC%9D%98+%EC%9C%A0%EB%A0%B9.png', NOW(), NOW()),
